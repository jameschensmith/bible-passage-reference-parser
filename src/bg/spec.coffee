...
describe "Localized book EpJer (bg)", ->
	...
	it "should handle book: EpJer (bg)", ->
		...
		expect(p.parse("Поел Иер 1:1").osis()).toEqual("EpJer.1.1")
		expect(p.parse("Пос. Иер 1:1").osis()).toEqual("EpJer.1.1")
...
describe "Localized book 1John (bg)", ->
	...
	it "should handle book: 1John (bg)", ->
		...
		expect(p.parse("Първо Иоаново 1:1").osis()).toEqual("1John.1.1")
		...
		expect(p.parse("Първо Иоан 1:1").osis()).toEqual("1John.1.1")
...
describe "Localized book 2John (bg)", ->
	...
	it "should handle book: 2John (bg)", ->
		...
		expect(p.parse("Второ Иоаново 1:1").osis()).toEqual("2John.1.1")
		...
		expect(p.parse("Второ Иоан 1:1").osis()).toEqual("2John.1.1")
...
describe "Localized book 3John (bg)", ->
	...
	it "should handle book: 3John (bg)", ->
		...
		expect(p.parse("Трета Иоаново 1:1").osis()).toEqual("3John.1.1")
		...
		expect(p.parse("Трета Иоан 1:1").osis()).toEqual("3John.1.1")
...
describe "Localized book 2Tim (bg)", ->
	...
	it "should handle book: 2Tim (bg)", ->
		...
		expect(p.parse("Второ Тимотеи 1:1").osis()).toEqual("2Tim.1.1")
...
describe "Localized book 1Tim (bg)", ->
	...
	it "should handle book: 1Tim (bg)", ->
		...
		expect(p.parse("Първо Тимотеи 1:1").osis()).toEqual("1Tim.1.1")
...
describe "Miscellaneous tests", ->
	...
	it "should handle book ranges (bg)", ->
		...
		expect(p.parse("Първа - Трета  Иоан").osis()).toEqual "1John.1-3John.1"
		expect(p.parse("Първа - Трета  Йоан").osis()).toEqual "1John.1-3John.1"
		return
