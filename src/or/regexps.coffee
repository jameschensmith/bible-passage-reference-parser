...
bcv_parser::regexps.get_books = (include_apocrypha, case_sensitive) ->
	...
	,
		osis: ["Isa"]
		regexp: ///(^|#{bcv_parser::regexps.pre_book})(
		(?:ଯ(?:ିଶାଇୟ(?:[\s\xa0]*ଭବିଷ୍ୟ‌ଦ୍‌ବକ୍ତାଙ୍କର[\s\xa0]*ପୁସ୍ତକ)?|[ାୀ]ଶାଇୟ)|ୟିଶାୟ|ୟଶାଇୟ|Isa)
			)(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]/"'\*=~\-\u2013\u2014])|$)///gi
	,
		osis: ["2Sam"]
		regexp: ///(^|[^0-9A-Za-zଁଅ-ଌଏ-ଐଓ-ନପ-ରଲ-ଳଵ-ହ଼-ଽିୁ-ୄ୍ୖଡ଼-ଢ଼ୟ-ୣୱ])(
	...
	,
		osis: ["Luke"]
		regexp: ///(^|#{bcv_parser::regexps.pre_book})(
		(?:ଲୂକ(?:[\s\xa0]*ଲିଖିତ[\s\xa0]*ସୁସମାଗ୍ଭର)?|Luke)
			)(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]/"'\*=~\-\u2013\u2014])|$)///gi
	,
		osis: ["1John"]
		regexp: ///(^|[^0-9A-Za-zଁଅ-ଌଏ-ଐଓ-ନପ-ରଲ-ଳଵ-ହ଼-ଽିୁ-ୄ୍ୖଡ଼-ଢ଼ୟ-ୣୱ])(
	...
	,
		osis: ["2Cor"]
		regexp: ///(^|[^0-9A-Za-zଁଅ-ଌଏ-ଐଓ-ନପ-ରଲ-ଳଵ-ହ଼-ଽିୁ-ୄ୍ୖଡ଼-ଢ଼ୟ-ୣୱ])(
		(?:2\.?[\s\xa0]*କରିନ୍ଥୀୟଙ୍କ)|(?:କରିନ୍ଥୀୟଙ୍କ[\s\xa0]*ପ୍ରତି[\s\xa0]*ଦ୍ୱିତୀୟ[\s\xa0]*ପତ୍ର|ଦ୍ୱିତୀୟ[\s\xa0]*କରିନ୍ଥୀୟଙ୍କ|ଦ୍ୱିତୀୟ[\s\xa0]*କରିନ୍ଥୀୟ|2(?:\.[\s\xa0]*କରିନ୍ଥୀୟ|[\s\xa0]*କରିନ୍ଥୀୟ|Cor))
			)(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]/"'\*=~\-\u2013\u2014])|$)///gi
	,
		osis: ["1Cor"]
		regexp: ///(^|[^0-9A-Za-zଁଅ-ଌଏ-ଐଓ-ନପ-ରଲ-ଳଵ-ହ଼-ଽିୁ-ୄ୍ୖଡ଼-ଢ଼ୟ-ୣୱ])(
		(?:1\.?[\s\xa0]*କରିନ୍ଥୀୟଙ୍କ)|(?:କରିନ୍ଥୀୟଙ୍କ[\s\xa0]*ପ୍ରତି[\s\xa0]*ପ୍ରଥମ[\s\xa0]*ପତ୍ର|ପ୍ରଥମ[\s\xa0]*କରିନ୍ଥୀୟଙ୍କ|ପ୍ରଥମ[\s\xa0]*କରିନ୍ଥୀୟ|1(?:\.[\s\xa0]*କରିନ୍ଥୀୟ|[\s\xa0]*କରିନ୍ଥୀୟ|Cor))
			)(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]/"'\*=~\-\u2013\u2014])|$)///gi
	,
		osis: ["Gal"]
		regexp: ///(^|#{bcv_parser::regexps.pre_book})(
