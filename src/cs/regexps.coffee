...
bcv_parser::regexps.get_books = (include_apocrypha, case_sensitive) ->
	...
	,
		osis: ["Num"]
		regexp: ///(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])(
		(?:[CČ]tvrt[a\xE1][\s\xa0]*(?:kniha[\s\xa0]*Moj[zž][i\xED][sš]|Moj[zž][i\xED][sš])ova|(?:IV|4)\.[\s\xa0]*(?:kniha[\s\xa0]*Moj[zž][i\xED][sš]|Moj[zž][i\xED][sš])ova|(?:IV|4)[\s\xa0]*(?:kniha[\s\xa0]*Moj[zž][i\xED][sš]|Moj[zž][i\xED][sš])ova|Nu(?:meri|m)?)
			)(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]/"'\*=~\-\u2013\u2014])|$)///gi
	,
		osis: ["Sir"]
		apocrypha: true
	...
	,
		osis: ["2Chr"]
		regexp: ///(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])(
		(?:Druh[ay\xE1\xFD][\s\xa0]*(?:Pa(?:ralipomenon)?|kniha[\s\xa0]*kronik|Letopis[uů]|Kronik)|(?:II|2)\.[\s\xa0]*(?:Pa(?:ralipomenon)?|kniha[\s\xa0]*kronik|Letopis[uů]|Kronik)|(?:II|2)[\s\xa0]*(?:Pa(?:ralipomenon)?|kniha[\s\xa0]*kronik|Letopis[uů]|Kronik)|2Chr)
			)(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]/"'\*=~\-\u2013\u2014])|$)///gi
	,
		osis: ["1Chr"]
		regexp: ///(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])(
		(?:Prvn[i\xED][\s\xa0]*(?:Pa(?:ralipomenon)?|kniha[\s\xa0]*kronik|Letopis[uů]|Kronik)|[1I]\.[\s\xa0]*(?:Pa(?:ralipomenon)?|kniha[\s\xa0]*kronik|Letopis[uů]|Kronik)|[1I][\s\xa0]*(?:Pa(?:ralipomenon)?|kniha[\s\xa0]*kronik|Letopis[uů]|Kronik)|1Chr)
			)(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]/"'\*=~\-\u2013\u2014])|$)///gi
	,
		osis: ["Ezra"]
		regexp: ///(^|#{bcv_parser::regexps.pre_book})(
	...
	,
		osis: ["Ps"]
		regexp: ///(^|#{bcv_parser::regexps.pre_book})(
		(?:Kniha[\s\xa0]*[zž]alm[uů]|[ZŽ]almy|[ZŽ](?:alm)?|Ps)
			)(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]/"'\*=~\-\u2013\u2014])|$)///gi
	,
		osis: ["PrAzar"]
		apocrypha: true
	...
	,
		osis: ["Phil"]
		regexp: ///(^|#{bcv_parser::regexps.pre_book})(
		(?:List[\s\xa0]*Filipsk[y\xFD]m|Filipensk[y\xFD]m|Filipsk[y\xFD]m|Phil|Fp)
			)(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]/"'\*=~\-\u2013\u2014])|$)///gi
	,
		osis: ["Col"]
		regexp: ///(^|#{bcv_parser::regexps.pre_book})(
	...
	,
		osis: ["Heb"]
		regexp: ///(^|#{bcv_parser::regexps.pre_book})(
		(?:List[\s\xa0]*(?:Hebrej[uů]|[ZŽ]id[uů])m|Hebrej[uů]m|[ZŽ]id[uů]m|Heb|[ZŽ]d)
			)(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]/"'\*=~\-\u2013\u2014])|$)///gi
	,
		osis: ["Jas"]
		regexp: ///(^|#{bcv_parser::regexps.pre_book})(
