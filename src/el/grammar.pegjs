...
// No `b` or `ps151`.
ff
  = val_1:(bcv / bcv_weak / bc / bv / cv / cv_weak / integer / c / v) sp "και"i space "μετ"i [άα]i abbrev? ![a-z]
...
v_letter
  = v_explicit? val:integer sp !( "και"i space "μετ"i [άα]i ) [α-ε]i ![a-z]
...
/* BCV helpers */
c_explicit
  = sp ( "κεφ"i  ( [άα]i "λαια"i / [άα]i "λαιον"i / [άα]i "λαιο"i / abbrev? ) ) sp
    { return {"type": "c_explicit"} }

v_explicit
  = sp ( "στ"i [ίι]i "χο"i ( "ς"i / "ι"i / "σ"i ) ) ![a-z] sp
...
title
  = (cv_sep / sequence_sep)? val:( "ο"i space "τ"i [ίι]i "τλος"i / "ο"i space "τ"i [ίι]i "τλοσ"i / "τ"i [ίι]i "τλος"i / "τ"i [ίι]i "τλοσ"i )
