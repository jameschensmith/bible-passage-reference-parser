...
// No `b` or `ps151`.
ff
  = val_1:(bcv / bcv_weak / bc / bv / cv / cv_weak / integer / c / v) sp ( "y" space "siguientes" / "y" space "sig" ) abbrev? ![a-z]
...
v_letter
  = v_explicit? val:integer sp !( ( "y" space "siguientes" / "y" space "sig" ) ) [a-e] ![a-z]
