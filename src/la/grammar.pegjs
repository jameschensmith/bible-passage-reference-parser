...
// No `b` or `ps151`.
ff
  = val_1:(bcv / bcv_weak / bc / bv / cv / cv_weak / integer / c / v) sp ( "et" space "sequentes" / "et" space "seq" abbrev? ) abbrev? ![a-z]
...
v_letter
  = v_explicit? val:integer sp !( ( "et" space "sequentes" / "et" space "seq" abbrev? ) ) [a-e] ![a-z]
...
v_explicit
  = sp ( "v" ( "ersus" / "ers" abbrev? / "er" abbrev? / abbrev? ) ) ![a-z] sp
...
title
  = (cv_sep / sequence_sep)? val:"titulus"
