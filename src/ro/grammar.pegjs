...
/* BCV helpers */
c_explicit
  = sp ( "cap" ( "itolele" / "itolul" / abbrev? ) ) sp
    { return {"type": "c_explicit"} }

v_explicit
  = sp ( "v" ( "ersetul" / "ersetele" / "ersete" / "ers" abbrev? / "s" abbrev? / abbrev? ) ) ![a-z] sp
...
sequence_sep
  = ([,;/:&\-\u2013\u2014~] / "." !(sp "." sp ".") / [şs]i "i" / "cf" abbrev? / "cp" abbrev? / space)+
    { return "" }
