...
// No `b` or `ps151`.
ff
  = val_1:(bcv / bcv_weak / bc / bv / cv / cv_weak / integer / c / v) sp "ss" abbrev? ![a-z]
...
v_letter
  = v_explicit? val:integer sp !( "ss" ) [a-e] ![a-z]
...
title
  = (cv_sep / sequence_sep)? val:"johdannolla"
