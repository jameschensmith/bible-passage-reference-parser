...
// No `b` or `ps151`.
ff
  = val_1:(bcv / bcv_weak / bc / bv / cv / cv_weak / integer / c / v) sp "и"i space "далее"i abbrev? ![a-z]
...
v_letter
  = v_explicit? val:integer sp !( "и"i space "далее"i ) [аб]i ![a-z]
...
/* BCV helpers */
c_explicit
  = sp ( "гл"i ( "авы"i / "ав"i / ""i abbrev? ) ) sp
    { return {"type": "c_explicit"} }

v_explicit
  = sp ( "стих"i ( "и"i / ""i ) ) ![a-z] sp
...
title
  = (cv_sep / sequence_sep)? val:"надписаниях"i
