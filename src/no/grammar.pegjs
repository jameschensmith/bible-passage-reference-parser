...
// No `b` or `ps151`.
ff
  = val_1:(bcv / bcv_weak / bc / bv / cv / cv_weak / integer / c / v) sp ( "ff" / "f" ) abbrev? ![a-z]
...
v_letter
  = v_explicit? val:integer sp !( ( "ff" / "f" ) ) [a-e] ![a-z]
...
/* BCV helpers */
c_explicit
  = sp ( "kap" ( "ittelet" / "ittel" / "itler" / "itlene" / "itel" / abbrev? ) ) sp
    { return {"type": "c_explicit"} }

v_explicit
  = sp ( "v" ( "ers" / abbrev? ) ) ![a-z] sp
...
title
  = (cv_sep / sequence_sep)? val:"overskrift"
